            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              <Card>
                <CardContent className="pt-6 text-center">
                  <div className="text-2xl font-bold mb-1">0.45 USDC</div>
              ...
              <Card>
                <CardContent className="pt-6 text-center">
                  <div className="text-2xl font-bold mb-1 text-primary">0.0285 USDC</div>
            ...
            <div className="md:col-span-1">
              <Card className="bg-primary text-primary-foreground">
                <CardContent className="p-6">
                  ...
                  <div className="text-3xl font-bold mb-2">0.3 USDC</div>
                ...
                <div className="rounded-md border">
                  ...
                  <div className="divide-y">
                    <div className="grid grid-cols-3 text-sm p-3">
                      ...
                      <div>Oct 15, 2023</div>
                      <div className="text-right">0.01 USDC</div>
                    </div>
                    <div className="grid grid-cols-3 text-sm p-3">
                      <div>Ethical Fashion</div>
                      <div>Oct 10, 2023</div>
                      <div className="text-right">0.015 USDC</div>
                    </div>
                    <div className="grid grid-cols-3 text-sm p-3">
                      <div>Muslim Bookstore</div>
                      <div>Oct 5, 2023</div>
                      <div className="text-right">0.0035 USDC</div>
                    </div>
                  </div>
                </div>
              </div>
