...
const enTranslations: Record<TranslationKey, string> = {
  ...
  "Connect your wallet to access Sanafi's Sharia-compliant financial services.": "Connect your wallet to access Sanafi's Sharia-compliant financial services.",
...
const arTranslations: Record<TranslationKey, string> = {
  ...
  "Connect your wallet to access Sanafi's Sharia-compliant financial services.": "قم بربط محفظتك للوصول إلى الخدمات المالية المتوافقة مع الشريعة الإسلامية من سنافي.",
